...
const ModalNotification: FunctionComponent<ModalNotificationProps> = ({ type, message, setError }) => {
    ...
    return (
        <>
            ...
            >
                <div className="mt-[230px] font-bold text-black text-[40px] text-center">{type === "success" ? "Woo hoo!" : "Oh no."}</div>
                ...
                <button
                    ...
                    className={`${
                        type === "success" ? "bg-primary shadow-primary hover:bg-blue-600" : "bg-red-500 shadow-red-500 hover:bg-red-600"
            ...
            <div onClick={() => setError("")} className="fixed top-0 left-0 w-full h-full z-20 bg-black/60"></div>
        </>
    );
};
