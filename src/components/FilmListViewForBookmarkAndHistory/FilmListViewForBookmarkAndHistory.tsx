...
const FilmListViewForBookmarkAndHistory: FunctionComponent<FilmListViewForBookmarkAndHistoryProps> = ({ films, isLoading, pageType }) => {
    ...
    return (
        <>
                    ...
                    <>
                        <div className="fixed top-[30%] md:left-[40%] left-[5%] right-[5%] md:w-[400px] z-40 bg-dark-lighten rounded-md min-h-[100px] shadow-md px-3 py-5">
                            ...
                            <div className="flex mt-8 justify-end">
                                <button onClick={() => setIsShowPrompt(false)} className="px-6 py-1 rounded-md text-white hover:brightness-75 transition duration-300">
                                    Cancel
                                </button>
                                <button onClick={clearSelection} className="px-6 py-1 rounded-md text-white bg-red-500 hover:bg-red-600 transition duration-300">
                                    Yes
                                </button>
                            </div>
                        </div>
                        <div onClick={() => setIsShowPrompt(false)} className="fixed top-0 left-0 w-full h-full z-30 bg-black/60"></div>
                    </>
                )}
            </div>
            ...
            <div className="md:flex hidden gap-6 items-center absolute top-4 right-5">
                ...
                <LazyLoadImage
                    src={currentUser ? (currentUser.photoURL as string) : "/defaultAvatar.jpg"}
                    alt="User avatar"
            ...
            <div className="flex">
                ...
                <div className="flex-grow px-[2vw] pb-16 pt-7 min-h-screen">
                    <h1 className="uppercase text-white font-semibold text-[35px] mb-4 ">{pageType === "bookmark" ? "My favourite films" : "Films I Watched"}</h1>
                    ...
                    >
                        <div className="inline-flex gap-[30px] pb-[14px] border-b border-gray-darken relative">
                            <button
                                ...
                                className={`${
                                    currentTab === "all" && "text-white font-medium after:absolute after:bottom-0 after:left-[0%] after:bg-white after:h-[3px] after:w-5"
                            ...
                            <button
                                ...
                                className={`${
                                    currentTab === "tv" && "text-white font-medium after:absolute after:bottom-0 after:left-[38%] after:bg-white after:h-[3px] after:w-5"
                                } transition duration-300 hover:text-white`}
                            >
                                TV Show
                            </button>
                            <button
                                ...
                                className={`${
                                    currentTab === "movie" && "text-white font-medium after:absolute after:bottom-0 after:right-[5%] after:bg-white after:h-[3px] after:w-5"
                                } transition duration-300 hover:text-white`}
                            >
                                Movie
                            </button>
                        ...
                        {!isEditing && (
                            <button onClick={() => setIsEditing(true)} className="self-end text-lg hover:text-primary transition duration-300 flex gap-2 items-center">
                        ...
                        {isEditing && (
                            <div className="flex gap-5 self-end">
                                ...
                                <button onClick={() => setIsEditing(false)} className=" text-lg hover:text-green-700 transition duration-300 flex gap-2 items-center">
                    ...
                    >
                        ...
                        {currentTab === "all" && <BookmarkResult films={films} isEditing={isEditing} selections={selections} setSelections={setSelections} isLoading={isLoading} pageType={pageType} />}
                        {currentTab === "tv" && (
                            <BookmarkResult
