    ...
    return (
      ...
      -translate-x-full fixed h-screen shadow-md transition duration-300 bg-dark-lighten z-50 ${isSidebarActive && "translate-x-0"}`}
            >
                ...
                <div className={`text-white text-lg font-medium ${isSidebarActive ? "-mt-6" : "mt-12"}`}>MENU</div>
            ...
            <p>Shorts</p>
                ...
                <div className="mt-8 ml-4 flex flex-col gap-6">
                    <button
                        ...
                        className={`flex gap-6 items-center  ${location.pathname === "/bookmarked" && "!text-primary border-r-4 border-primary font-medium"} hover:text-white transition duration-300`}
                    >
                ...
                <div className="mt-8 ml-4 flex flex-col gap-6">
                    ...
                    {!currentUser && (
                        <Link to={`/auth?redirect=${encodeURIComponent(location.pathname)}`} className="flex gap-5 items-center">
                    ...
                    {currentUser && (
                        <button onClick={signOutHandler} className="flex gap-5 items-center">
